# Auto-generated from iec62325-451-7-activationdocument_v6_4.xsd — DO NOT EDIT
# Re-run `gen/regenerate_xml_models.jl` to regenerate.
# Source schema namespace: urn:iec62325.351:tc57wg16:451-7:activationdocument:6:4

module Activationdocument_v6_4
...
Base.@kwdef mutable struct AccountingPoint
    activation_MarketParticipant_mRID::Union{Nothing, PartyID_String} = nothing
    activation_MarketParticipant_marketRole_type::Union{Nothing, String} = nothing
...
Base.@kwdef mutable struct TimeSeries
    ...
    related_MarketParticipant_mRID::Union{Nothing, PartyID_String} = nothing
    related_MarketParticipant_marketRole_type::Union{Nothing, String} = nothing
...
function _parse(::Type{AccountingPoint}, n::EzXML.Node)
    ...
    for c in elements(n)
        local nm = nodename(c)
        if nm == "activation_MarketParticipant.mRID"
            out.activation_MarketParticipant_mRID = _parse(PartyID_String, c)
        elseif nm == "activation_MarketParticipant.marketRole.type"
            out.activation_MarketParticipant_marketRole_type = String(strip(nodecontent(c)))
...
function _parse(::Type{TimeSeries}, n::EzXML.Node)
    ...
    for c in elements(n)
        ...
        elseif nm == "related_MarketParticipant.mRID"
            out.related_MarketParticipant_mRID = _parse(PartyID_String, c)
        elseif nm == "related_MarketParticipant.marketRole.type"
            out.related_MarketParticipant_marketRole_type = String(strip(nodecontent(c)))
...
end  # module Activationdocument_v6_4
