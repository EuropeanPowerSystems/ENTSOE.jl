# Auto-generated from iec62325-451-n-capacityallocationconfiguration_v1_0.xsd — DO NOT EDIT
# Re-run `gen/regenerate_xml_models.jl` to regenerate.
# Source schema namespace: urn:iec62325.351:tc57wg16:451-n:capacityallocationconfigurationdocument:1:0

module Capacityallocationconfiguration_v1_0
...
Base.@kwdef mutable struct Allocation_TimeSeries
    ...
    subType_Auction_allocationMode::Union{Nothing, String} = nothing
...
function _parse(::Type{Allocation_TimeSeries}, n::EzXML.Node)
    ...
    for c in elements(n)
        ...
        elseif nm == "subType_Auction.allocationMode"
            out.subType_Auction_allocationMode = String(strip(nodecontent(c)))
...
end  # module Capacityallocationconfiguration_v1_0
