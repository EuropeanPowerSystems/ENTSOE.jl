# Auto-generated from iec62325-451-n-resourcecapacitymarketunitdocument_v1_0.xsd — DO NOT EDIT
# Re-run `gen/regenerate_xml_models.jl` to regenerate.
# Source schema namespace: urn:iec62325.351:tc57wg16:451-n:resourcecapacitymarketunitdocument:1:0

module Resourcecapacitymarketunitdocument_v1_0
...
Base.@kwdef mutable struct MeteringPoint_AggregateNode
...
Base.@kwdef mutable struct Unit_RegisteredResource
    ...
    MeteringPoint_AggregateNode::Vector{MeteringPoint_AggregateNode} = MeteringPoint_AggregateNode[]
end
...
Base.@kwdef mutable struct TimeSeries
    ...
    marketParticipation_MarketObjectStatus_status::Union{Nothing, String} = nothing
...
function _parse(::Type{MeteringPoint_AggregateNode}, n::EzXML.Node)
    out = MeteringPoint_AggregateNode()
    for c in elements(n)
        local nm = nodename(c)
        if nm == "mRID"
...
function _parse(::Type{Unit_RegisteredResource}, n::EzXML.Node)
    ...
    for c in elements(n)
        ...
        elseif nm == "MeteringPoint_AggregateNode"
            push!(out.MeteringPoint_AggregateNode, _parse(MeteringPoint_AggregateNode, c))
        end
    end
    return out
end
...
function _parse(::Type{TimeSeries}, n::EzXML.Node)
    ...
    for c in elements(n)
        ...
        elseif nm == "marketParticipation_MarketObjectStatus.status"
            out.marketParticipation_MarketObjectStatus_status = String(strip(nodecontent(c)))
...
end  # module Resourcecapacitymarketunitdocument_v1_0
