# Auto-generated from iec62325-451-3-allocation_v7_2.xsd — DO NOT EDIT
# Re-run `gen/regenerate_xml_models.jl` to regenerate.
# Source schema namespace: urn:iec62325.351:tc57wg16:451-3:allocationresultdocument:7:2

module Allocation_v7_2
...
Base.@kwdef mutable struct TimeSeries
    mRID::String = ""
    bid_Original_MarketDocument_mRID::Union{Nothing, String} = nothing
    bid_Original_MarketDocument_revisionNumber::Union{Nothing, String} = nothing
    bid_Original_MarketDocument_bid_TimeSeries_mRID::Union{Nothing, String} = nothing
    auction_mRID::String = ""
...
Base.@kwdef mutable struct AllocationResult_MarketDocument
    mRID::String = ""
    ...
    subjectParty_MarketParticipant_mRID::PartyID_String = PartyID_String()
    subjectParty_MarketParticipant_marketRole_type::String = ""
...
function _parse(::Type{AllocationResult_MarketDocument}, n::EzXML.Node)
    out = AllocationResult_MarketDocument()
    for c in elements(n)
        local nm = nodename(c)
        if nm == "mRID"
            out.mRID = String(strip(nodecontent(c)))
        ...
        elseif nm == "subjectParty_MarketParticipant.mRID"
            out.subjectParty_MarketParticipant_mRID = _parse(PartyID_String, c)
        elseif nm == "subjectParty_MarketParticipant.marketRole.type"
            out.subjectParty_MarketParticipant_marketRole_type = String(strip(nodecontent(c)))
...
function parse_document(xml::AbstractString)::AllocationResult_MarketDocument
    return _parse(AllocationResult_MarketDocument, root(parsexml(xml)))
end

end  # module Allocation_v7_2
