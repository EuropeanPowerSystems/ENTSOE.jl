# Auto-generated from iec62325-451-n-crac_v1_1.xsd — DO NOT EDIT
# Re-run `gen/regenerate_xml_models.jl` to regenerate.
# Source schema namespace: urn:iec62325.351:tc57wg16:451-n:CRACdocument:1:1
...
Base.@kwdef mutable struct Contingency_Series
    mRID::String = ""
    name::Union{Nothing, String} = nothing
    Contingency_RegisteredResource::Vector{Contingency_RegisteredResource} = Contingency_RegisteredResource[]
end
...
function _parse(::Type{Contingency_Series}, n::EzXML.Node)
    ...
    for c in elements(n)
        ...
        elseif nm == "name"
            out.name = String(strip(nodecontent(c)))
        elseif nm == "Contingency_RegisteredResource"
            push!(out.Contingency_RegisteredResource, _parse(Contingency_RegisteredResource, c))
        end
    end
    return out
end
