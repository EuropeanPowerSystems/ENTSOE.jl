# Auto-generated from iec62325-451-n-crac_v2_4.xsd — DO NOT EDIT
# Re-run `gen/regenerate_xml_models.jl` to regenerate.
# Source schema namespace: urn:iec62325.351:tc57wg16:451-n:CRACdocument:2:4
...
Base.@kwdef mutable struct RemedialAction_Series
    ...
    availability_MarketObjectStatus_status::Union{Nothing, String} = nothing
...
function _parse(::Type{RemedialAction_Series}, n::EzXML.Node)
    ...
    for c in elements(n)
        ...
        elseif nm == "availability_MarketObjectStatus.status"
            out.availability_MarketObjectStatus_status = String(strip(nodecontent(c)))
