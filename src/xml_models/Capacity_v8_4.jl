# Auto-generated from iec62325-451-3-capacity_v8_4.xsd — DO NOT EDIT
# Re-run `gen/regenerate_xml_models.jl` to regenerate.
# Source schema namespace: urn:iec62325.351:tc57wg16:451-3:capacitydocument:8:4

module Capacity_v8_4
...
Base.@kwdef mutable struct TimeSeries
    ...
    secondary_Measurement_Unit_name::Union{Nothing, String} = nothing
    ...
    requesting_MarketParticipant_mRID::Union{Nothing, PartyID_String} = nothing
    requesting_MarketParticipant_marketRole_type::Union{Nothing, String} = nothing
    ...
    AttributeInstanceComponent_attributeValue::Union{Nothing, AttributeValue_String} = nothing
    AttributeInstanceComponent_position::Union{Nothing, Int64} = nothing
end

Base.@kwdef mutable struct Capacity_MarketDocument
    mRID::String = ""
...
function _parse(::Type{TimeSeries}, n::EzXML.Node)
    ...
    for c in elements(n)
        ...
        elseif nm == "secondary_Measurement_Unit.name"
            out.secondary_Measurement_Unit_name = String(strip(nodecontent(c)))
        ...
        elseif nm == "requesting_MarketParticipant.mRID"
            out.requesting_MarketParticipant_mRID = _parse(PartyID_String, c)
        elseif nm == "requesting_MarketParticipant.marketRole.type"
            out.requesting_MarketParticipant_marketRole_type = String(strip(nodecontent(c)))
        ...
        elseif nm == "AttributeInstanceComponent.attributeValue"
            out.AttributeInstanceComponent_attributeValue = _parse(AttributeValue_String, c)
...
function _parse(::Type{Capacity_MarketDocument}, n::EzXML.Node)
    out = Capacity_MarketDocument()
    for c in elements(n)
        local nm = nodename(c)
        if nm == "mRID"
            out.mRID = String(strip(nodecontent(c)))
...
function parse_document(xml::AbstractString)::Capacity_MarketDocument
    return _parse(Capacity_MarketDocument, root(parsexml(xml)))
end

end  # module Capacity_v8_4
