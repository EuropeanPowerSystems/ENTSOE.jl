# Auto-generated from iec62325-451-n-smtaresults_v_1_0.xsd — DO NOT EDIT
# Re-run `gen/regenerate_xml_models.jl` to regenerate.
# Source schema namespace: urn:iec62325.351:tc57wg16:451-n:smtaresultsdocument:1:0

module Smtaresults_v_1_0
...
Base.@kwdef mutable struct ShortMediumTermAdequacyResults_MarketDocument
    mRID::String = ""
...
function _parse(::Type{ShortMediumTermAdequacyResults_MarketDocument}, n::EzXML.Node)
    out = ShortMediumTermAdequacyResults_MarketDocument()
    for c in elements(n)
        local nm = nodename(c)
        if nm == "mRID"
            out.mRID = String(strip(nodecontent(c)))
...
function parse_document(xml::AbstractString)::ShortMediumTermAdequacyResults_MarketDocument
    return _parse(ShortMediumTermAdequacyResults_MarketDocument, root(parsexml(xml)))
end

end  # module Smtaresults_v_1_0
