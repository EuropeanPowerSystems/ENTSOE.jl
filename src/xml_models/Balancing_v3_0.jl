# Auto-generated from iec62325-451-6-balancing_v3_0.xsd — DO NOT EDIT
# Re-run `gen/regenerate_xml_models.jl` to regenerate.
# Source schema namespace: urn:iec62325.351:tc57wg16:451-6:balancingdocument:3:0

module Balancing_v3_0
...
Base.@kwdef mutable struct Balancing_MarketDocument
    ...
    controlArea_Domain_mRID::Union{Nothing, AreaID_String} = nothing
...
function _parse(::Type{Balancing_MarketDocument}, n::EzXML.Node)
    ...
    for c in elements(n)
        ...
        elseif nm == "controlArea_Domain.mRID"
            out.controlArea_Domain_mRID = _parse(AreaID_String, c)
