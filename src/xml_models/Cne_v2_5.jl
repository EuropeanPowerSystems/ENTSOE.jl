# Auto-generated from iec62325-451-n-cne_v2_5.xsd — DO NOT EDIT
# Re-run `gen/regenerate_xml_models.jl` to regenerate.
# Source schema namespace: urn:iec62325.351:tc57wg16:451-n:cnedocument:2:5
...
Base.@kwdef mutable struct Border_Series
    ...
    ConnectingLine_RegisteredResource::Vector{Monitored_RegisteredResource} = Monitored_RegisteredResource[]
end
...
Base.@kwdef mutable struct Monitored_Series
    mRID::String = ""
    name::Union{Nothing, String} = nothing
    Party_MarketParticipant::Vector{Party_MarketParticipant} = Party_MarketParticipant[]
    RegisteredResource::Vector{Monitored_RegisteredResource} = Monitored_RegisteredResource[]
    Reason::Vector{Series_Reason} = Series_Reason[]
end
...
Base.@kwdef mutable struct Constraint_Series
    ...
    constraintStatus_MarketObjectStatus_status::Union{Nothing, String} = nothing
    ...
    Monitored_Series::Vector{Monitored_Series} = Monitored_Series[]
...
function _parse(::Type{Border_Series}, n::EzXML.Node)
    ...
    for c in elements(n)
        ...
        elseif nm == "ConnectingLine_RegisteredResource"
            push!(out.ConnectingLine_RegisteredResource, _parse(Monitored_RegisteredResource, c))
        end
    end
    return out
end
...
function _parse(::Type{Monitored_Series}, n::EzXML.Node)
    out = Monitored_Series()
    for c in elements(n)
        local nm = nodename(c)
        if nm == "mRID"
            out.mRID = String(strip(nodecontent(c)))
        ...
        elseif nm == "Party_MarketParticipant"
            push!(out.Party_MarketParticipant, _parse(Party_MarketParticipant, c))
        elseif nm == "RegisteredResource"
            push!(out.RegisteredResource, _parse(Monitored_RegisteredResource, c))
        elseif nm == "Reason"
            push!(out.Reason, _parse(Series_Reason, c))
        end
    end
...
function _parse(::Type{Constraint_Series}, n::EzXML.Node)
    ...
    for c in elements(n)
        ...
        elseif nm == "constraintStatus_MarketObjectStatus.status"
            out.constraintStatus_MarketObjectStatus_status = String(strip(nodecontent(c)))
        ...
        elseif nm == "Monitored_Series"
            push!(out.Monitored_Series, _parse(Monitored_Series, c))
