# Auto-generated from iec62325-451-n-areaconfigurationdocument_v1_2.xsd — DO NOT EDIT
# Re-run `gen/regenerate_xml_models.jl` to regenerate.
# Source schema namespace: urn:iec62325.351:tc57wg16:451-n:areaconfigurationdocument:1:2

module Areaconfigurationdocument_v1_2
...
Base.@kwdef mutable struct ConsistOf_Domain
    ...
    area_ObjectType_type::Union{Nothing, String} = nothing
    subArea_ObjectType_type::Union{Nothing, String} = nothing
end
...
Base.@kwdef mutable struct AreaSpecification_Series
    ...
    area_Domain_area_ObjectType_type::Union{Nothing, String} = nothing
    area_Domain_subArea_ObjectType_type::Union{Nothing, String} = nothing
...
function _parse(::Type{ConsistOf_Domain}, n::EzXML.Node)
    ...
    for c in elements(n)
        ...
        elseif nm == "area_ObjectType.type"
            out.area_ObjectType_type = String(strip(nodecontent(c)))
        elseif nm == "subArea_ObjectType.type"
            out.subArea_ObjectType_type = String(strip(nodecontent(c)))
        end
    end
    return out
end
...
function _parse(::Type{AreaSpecification_Series}, n::EzXML.Node)
    ...
    for c in elements(n)
        ...
        elseif nm == "area_Domain.area_ObjectType.type"
            out.area_Domain_area_ObjectType_type = String(strip(nodecontent(c)))
        elseif nm == "area_Domain.subArea_ObjectType.type"
            out.area_Domain_subArea_ObjectType_type = String(strip(nodecontent(c)))
...
end  # module Areaconfigurationdocument_v1_2
