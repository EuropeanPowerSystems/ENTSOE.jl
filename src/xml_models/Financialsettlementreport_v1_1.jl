# Auto-generated from iec62325-451-n-financialsettlementreport_v1_1.xsd — DO NOT EDIT
# Re-run `gen/regenerate_xml_models.jl` to regenerate.
# Source schema namespace: urn:iec62325.351:tc57wg16:451-6:financialsettlementreportdocument:1:1

module Financialsettlementreport_v1_1
...
Base.@kwdef mutable struct Point
    ...
    monetaryValue_Quantity_quantity::Union{Nothing, Float64} = nothing
...
Base.@kwdef mutable struct TimeSeries
    ...
    Reason::Vector{Reason} = Reason[]
    energyMarket_timeframe::Union{Nothing, String} = nothing
    flowDirection_direction::Union{Nothing, String} = nothing
end

Base.@kwdef mutable struct FinancialSettlementReport_MarketDocument
    mRID::String = ""
...
function _parse(::Type{Point}, n::EzXML.Node)
    ...
    for c in elements(n)
        ...
        elseif nm == "monetaryValue_Quantity.quantity"
            out.monetaryValue_Quantity_quantity = (x -> parse(Float64, x))(strip(nodecontent(c)))
        elseif nm == "Reason"
...
function _parse(::Type{TimeSeries}, n::EzXML.Node)
    ...
    for c in elements(n)
        ...
        elseif nm == "Reason"
            push!(out.Reason, _parse(Reason, c))
        elseif nm == "energyMarket.timeframe"
            out.energyMarket_timeframe = String(strip(nodecontent(c)))
...
function _parse(::Type{FinancialSettlementReport_MarketDocument}, n::EzXML.Node)
    out = FinancialSettlementReport_MarketDocument()
    for c in elements(n)
        local nm = nodename(c)
        if nm == "mRID"
            out.mRID = String(strip(nodecontent(c)))
...
function parse_document(xml::AbstractString)::FinancialSettlementReport_MarketDocument
    return _parse(FinancialSettlementReport_MarketDocument, root(parsexml(xml)))
end

end  # module Financialsettlementreport_v1_1
