# Auto-generated from iec62325-451-n-reporting_v2_1.xsd — DO NOT EDIT
# Re-run `gen/regenerate_xml_models.jl` to regenerate.
# Source schema namespace: urn:iec62325.351:tc57wg16:451-n:reportingdocument:2:1

module Reporting_v2_1
...
Base.@kwdef mutable struct Reporting_MarketDocument
    mRID::String = ""
...
function _parse(::Type{Reporting_MarketDocument}, n::EzXML.Node)
    out = Reporting_MarketDocument()
    for c in elements(n)
        local nm = nodename(c)
        if nm == "mRID"
            out.mRID = String(strip(nodecontent(c)))
...
function parse_document(xml::AbstractString)::Reporting_MarketDocument
    return _parse(Reporting_MarketDocument, root(parsexml(xml)))
end

end  # module Reporting_v2_1
