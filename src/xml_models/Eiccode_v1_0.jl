# Auto-generated from iec62325-451-n-eiccode_v1_0.xsd — DO NOT EDIT
# Re-run `gen/regenerate_xml_models.jl` to regenerate.
# Source schema namespace: urn:iec62325.351:tc57wg16:451-n:eicdocument:1:0
...
Base.@kwdef mutable struct StreetAddress
    streetDetail::Union{Nothing, StreetDetail} = nothing
    postalCode::Union{Nothing, String} = nothing
    townDetail::Union{Nothing, TownDetail} = nothing
end
