# Auto-generated from iec62325-451-n-weatherconfigurationdocument_v1_0.xsd — DO NOT EDIT
# Re-run `gen/regenerate_xml_models.jl` to regenerate.
# Source schema namespace: urn:iec62325.351:tc57wg16:451-n:weatherconfigurationdocument:1:0

module Weatherconfigurationdocument_v1_0
...
Base.@kwdef mutable struct RegisteredResource
    ...
    location_coordinateSystem_name::Union{Nothing, String} = nothing
end
...
function _parse(::Type{RegisteredResource}, n::EzXML.Node)
    ...
    for c in elements(n)
        ...
        elseif nm == "location.coordinateSystem.name"
            out.location_coordinateSystem_name = String(strip(nodecontent(c)))
        end
    end
    return out
end
...
end  # module Weatherconfigurationdocument_v1_0
