# Auto-generated from iec62325-451-n-reportinginformation_v2_3.xsd — DO NOT EDIT
# Re-run `gen/regenerate_xml_models.jl` to regenerate.
# Source schema namespace: urn:iec62325.351:tc57wg16:451-n:reportinginformationdocument:2:3

module Reportinginformation_v2_3
...
Base.@kwdef mutable struct ReportingInformation_MarketDocument
    ...
    process_energyMarket_timeframe::Union{Nothing, String} = nothing
...
function _parse(::Type{ReportingInformation_MarketDocument}, n::EzXML.Node)
    ...
    for c in elements(n)
        ...
        elseif nm == "process.energyMarket.timeframe"
            out.process_energyMarket_timeframe = String(strip(nodecontent(c)))
...
end  # module Reportinginformation_v2_3
