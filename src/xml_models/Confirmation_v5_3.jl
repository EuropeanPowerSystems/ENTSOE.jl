# Auto-generated from iec62325-451-2-confirmation_v5_3.xsd — DO NOT EDIT
# Re-run `gen/regenerate_xml_models.jl` to regenerate.
# Source schema namespace: urn:iec62325.351:tc57wg16:451-2:confirmationdocument:5:3

module Confirmation_v5_3
...
Base.@kwdef mutable struct Confirmation_MarketDocument
    ...
    related_MarketDocument_mRID::Union{Nothing, String} = nothing
    related_MarketDocument_revisionNumber::Union{Nothing, String} = nothing
...
function _parse(::Type{Confirmation_MarketDocument}, n::EzXML.Node)
    ...
    for c in elements(n)
        ...
        elseif nm == "related_MarketDocument.mRID"
            out.related_MarketDocument_mRID = String(strip(nodecontent(c)))
        elseif nm == "related_MarketDocument.revisionNumber"
            out.related_MarketDocument_revisionNumber = String(strip(nodecontent(c)))
