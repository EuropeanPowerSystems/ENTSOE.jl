# Auto-generated from iec62325-451-3-rights_v7_1.xsd — DO NOT EDIT
# Re-run `gen/regenerate_xml_models.jl` to regenerate.
# Source schema namespace: urn:iec62325.351:tc57wg16:451-3:rightsdocument:7:1
...
Base.@kwdef mutable struct TimeSeries
    ...
    holder_Rights_MarketParticipant_mRID::PartyID_String = PartyID_String()
    transferee_Rights_MarketParticipant_mRID::Union{Nothing, PartyID_String} = nothing
    marketAgreement_mRID::String = ""
    marketAgreement_type::String = ""
    previous_MarketAgreement_mRID::Union{Nothing, String} = nothing
...
Base.@kwdef mutable struct Rights_MarketDocument
    mRID::String = ""
...
function _parse(::Type{TimeSeries}, n::EzXML.Node)
    ...
    for c in elements(n)
        ...
        elseif nm == "holder_Rights_MarketParticipant.mRID"
            out.holder_Rights_MarketParticipant_mRID = _parse(PartyID_String, c)
        elseif nm == "transferee_Rights_MarketParticipant.mRID"
            out.transferee_Rights_MarketParticipant_mRID = _parse(PartyID_String, c)
        ...
        elseif nm == "previous_MarketAgreement.mRID"
            out.previous_MarketAgreement_mRID = String(strip(nodecontent(c)))
...
function _parse(::Type{Rights_MarketDocument}, n::EzXML.Node)
    out = Rights_MarketDocument()
    for c in elements(n)
        local nm = nodename(c)
        if nm == "mRID"
            out.mRID = String(strip(nodecontent(c)))
...
function parse_document(xml::AbstractString)::Rights_MarketDocument
    return _parse(Rights_MarketDocument, root(parsexml(xml)))
end

end  # module Rights_v7_1
