# Auto-generated from iec62325-451-n-reportingstatus_v2_2.xsd — DO NOT EDIT
# Re-run `gen/regenerate_xml_models.jl` to regenerate.
# Source schema namespace: urn:iec62325.351:tc57wg16:451-n:reportingstatusdocument:2:2

module Reportingstatus_v2_2
...
Base.@kwdef mutable struct TimeSeries
    ...
    original_MarketDocument_originalSender_MarketParticipant_mRID::Union{Nothing, PartyID_String} = nothing
    original_MarketDocument_createdDateTime::Union{Nothing, DateTime} = nothing
    original_MarketDocument_original_Domain_mRID::Union{Nothing, AreaID_String} = nothing
    original_MarketDocument_original_TimeSeries_mRID::Union{Nothing, String} = nothing
    businessType::String = ""
    product::String = ""
...
end  # module Reportingstatus_v2_2
