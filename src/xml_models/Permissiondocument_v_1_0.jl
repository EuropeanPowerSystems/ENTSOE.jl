# Auto-generated from iec62325-451-n-permissiondocument_v_1_0.xsd — DO NOT EDIT
# Re-run `gen/regenerate_xml_models.jl` to regenerate.
# Source schema namespace: urn:iec62325.351:tc57wg16:451-n:permissiondocument:1:0

module Permissiondocument_v_1_0
...
Base.@kwdef mutable struct Permission
    ...
    createdDateTime::Union{Nothing, String} = nothing
    permitted_MarketParticipant_mRID::Union{Nothing, String} = nothing
    permitted_MarketParticipant_marketRole_type::Union{Nothing, String} = nothing
    permitting_MarketParticipant_mRID::Union{Nothing, String} = nothing
    ...
    permissionStatus_status::Union{Nothing, String} = nothing
    transmissionSchedule_Period_resolution::Union{Nothing, String} = nothing
    transmissionSchedule_Period_timeInterval::Union{Nothing, String} = nothing
...
Base.@kwdef mutable struct AccountingPoint
    ...
    Permission::Vector{String} = String[]
end
...
Base.@kwdef mutable struct Permission_MarketDocument
    ...
    MktActivityRecord::Vector{String} = String[]
end
...
function _parse(::Type{Permission}, n::EzXML.Node)
    ...
    for c in elements(n)
        ...
        elseif nm == "permitted_MarketParticipant.mRID"
            out.permitted_MarketParticipant_mRID = String(strip(nodecontent(c)))
        ...
        elseif nm == "permitting_MarketParticipant.mRID"
            out.permitting_MarketParticipant_mRID = String(strip(nodecontent(c)))
        ...
        elseif nm == "permissionStatus.status"
            out.permissionStatus_status = String(strip(nodecontent(c)))
        ...
        elseif nm == "transmissionSchedule_Period.timeInterval"
            out.transmissionSchedule_Period_timeInterval = String(strip(nodecontent(c)))
        elseif nm == "Series"
            push!(out.Series, String(strip(nodecontent(c))))
        end
    end
    return out
end
...
function _parse(::Type{AccountingPoint}, n::EzXML.Node)
    ...
    for c in elements(n)
        ...
        elseif nm == "Permission"
            push!(out.Permission, String(strip(nodecontent(c))))
        end
    end
    return out
end
...
function _parse(::Type{Permission_MarketDocument}, n::EzXML.Node)
    ...
    for c in elements(n)
        ...
        elseif nm == "MktActivityRecord"
            push!(out.MktActivityRecord, String(strip(nodecontent(c))))
        end
    end
    return out
end
...
end  # module Permissiondocument_v_1_0
