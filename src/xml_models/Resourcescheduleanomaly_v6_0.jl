# Auto-generated from iec62325-451-7-resourcescheduleanomaly_v6_0.xsd — DO NOT EDIT
# Re-run `gen/regenerate_xml_models.jl` to regenerate.
# Source schema namespace: urn:iec62325.351:tc57wg16:451-7:resourcescheduleanomalydocument:6:0

module Resourcescheduleanomaly_v6_0
...
Base.@kwdef mutable struct Sender_Original_MarketDocument
    mRID::String = ""
...
Base.@kwdef mutable struct ResourceScheduleAnomaly_MarketDocument
    ...
    SenderOriginal_MarketDocument::Vector{Sender_Original_MarketDocument} = Sender_Original_MarketDocument[]
    Reason::Vector{Reason} = Reason[]
end
...
function _parse(::Type{Sender_Original_MarketDocument}, n::EzXML.Node)
    out = Sender_Original_MarketDocument()
    for c in elements(n)
        local nm = nodename(c)
        if nm == "mRID"
            out.mRID = String(strip(nodecontent(c)))
...
function _parse(::Type{ResourceScheduleAnomaly_MarketDocument}, n::EzXML.Node)
    ...
    for c in elements(n)
        ...
        elseif nm == "SenderOriginal_MarketDocument"
            push!(out.SenderOriginal_MarketDocument, _parse(Sender_Original_MarketDocument, c))
        elseif nm == "Reason"
            push!(out.Reason, _parse(Reason, c))
        end
    end
...
end  # module Resourcescheduleanomaly_v6_0
