# Auto-generated from iec62325-451-6-balancing_v4_5.xsd — DO NOT EDIT
# Re-run `gen/regenerate_xml_models.jl` to regenerate.
# Source schema namespace: urn:iec62325.351:tc57wg16:451-6:balancingdocument:4:5

module Balancing_v4_5
...
Base.@kwdef mutable struct Financial_Price
    ...
    priceDescriptor_type::Union{Nothing, String} = nothing
end
...
function _parse(::Type{Financial_Price}, n::EzXML.Node)
    ...
    for c in elements(n)
        ...
        elseif nm == "priceDescriptor.type"
            out.priceDescriptor_type = String(strip(nodecontent(c)))
        end
    end
    return out
end
