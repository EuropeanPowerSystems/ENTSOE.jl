# Auto-generated from iec62325-451-7-reserveallocationresult_v6_5.xsd — DO NOT EDIT
# Re-run `gen/regenerate_xml_models.jl` to regenerate.
# Source schema namespace: urn:iec62325.351:tc57wg16:451-7:reserveallocationresultdocument:6:5

module Reserveallocationresult_v6_5
...
Base.@kwdef mutable struct Point
    ...
    financial_Price_amount::Union{Nothing, Float64} = nothing
...
Base.@kwdef mutable struct TimeSeries
    ...
    bid_Original_MarketDocument_bid_BidTimeSeries_mRID::Union{Nothing, String} = nothing
    bid_Original_MarketDocument_tendering_MarketParticipant_mRID::Union{Nothing, PartyID_String} = nothing
...
function _parse(::Type{Point}, n::EzXML.Node)
    ...
    for c in elements(n)
        ...
        elseif nm == "financial_Price.amount"
            out.financial_Price_amount = (x -> parse(Float64, x))(strip(nodecontent(c)))
        elseif nm == "Reason"
...
function _parse(::Type{TimeSeries}, n::EzXML.Node)
    ...
    for c in elements(n)
        ...
        elseif nm == "bid_Original_MarketDocument.bid_BidTimeSeries.mRID"
            out.bid_Original_MarketDocument_bid_BidTimeSeries_mRID = String(strip(nodecontent(c)))
...
end  # module Reserveallocationresult_v6_5
