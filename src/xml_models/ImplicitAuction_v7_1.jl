# Auto-generated from iec62325-451-3-implicitAuction_v7_1.xsd — DO NOT EDIT
# Re-run `gen/regenerate_xml_models.jl` to regenerate.
# Source schema namespace: urn:iec62325.351:tc57wg16:451-3:implicitauctiondocument:7:1

module ImplicitAuction_v7_1
...
function _parse(::Type{ImplicitAuctionResult_MarketDocument}, n::EzXML.Node)
    out = ImplicitAuctionResult_MarketDocument()
    for c in elements(n)
        local nm = nodename(c)
        if nm == "mRID"
            out.mRID = String(strip(nodecontent(c)))
...
function parse_document(xml::AbstractString)::ImplicitAuctionResult_MarketDocument
    return _parse(ImplicitAuctionResult_MarketDocument, root(parsexml(xml)))
end

end  # module ImplicitAuction_v7_1
