# Auto-generated from iec62325-451-3-totalallocation_v7_0.xsd — DO NOT EDIT
# Re-run `gen/regenerate_xml_models.jl` to regenerate.
# Source schema namespace: urn:iec62325.351:tc57wg16:451-3:totalallocationresultdocument:7:0

module Totalallocation_v7_0
...
Base.@kwdef mutable struct TimeSeries
    ...
    bidDocument_MarketDocument_bidTimeSeries_mRID::Union{Nothing, String} = nothing
...
function _parse(::Type{TimeSeries}, n::EzXML.Node)
    ...
    for c in elements(n)
        ...
        elseif nm == "bidDocument_MarketDocument.bidTimeSeries.mRID"
            out.bidDocument_MarketDocument_bidTimeSeries_mRID = String(strip(nodecontent(c)))
...
end  # module Totalallocation_v7_0
