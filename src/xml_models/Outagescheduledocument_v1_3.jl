# Auto-generated from iec62325-451-n-outagescheduledocument_v1_3.xsd — DO NOT EDIT
# Re-run `gen/regenerate_xml_models.jl` to regenerate.
# Source schema namespace: urn:iec62325.351:tc57wg16:451-n:outagescheduledocument:1:3

module Outagescheduledocument_v1_3
...
Base.@kwdef mutable struct TimeSeries
    ...
    businessType::String = ""
    Project_Names::Union{Nothing, Name} = nothing
    CaseReference_Names::Union{Nothing, Name} = nothing
    PartnerCaseReference_Names::Vector{Name} = Name[]
...
function _parse(::Type{Name}, n::EzXML.Node)
    out = Name()
    for c in elements(n)
        local nm = nodename(c)
        if nm == "name"
...
function _parse(::Type{TimeSeries}, n::EzXML.Node)
    ...
    for c in elements(n)
        ...
        elseif nm == "Project_Names"
            out.Project_Names = _parse(Name, c)
        elseif nm == "CaseReference_Names"
            out.CaseReference_Names = _parse(Name, c)
        elseif nm == "PartnerCaseReference_Names"
            push!(out.PartnerCaseReference_Names, _parse(Name, c))
...
end  # module Outagescheduledocument_v1_3
