# Auto-generated from iec62325-451-7-reservebiddocument_v7_6.xsd — DO NOT EDIT
# Re-run `gen/regenerate_xml_models.jl` to regenerate.
# Source schema namespace: urn:iec62325.351:tc57wg16:451-7:reservebiddocument:7:6

module Reservebiddocument_v7_6
...
Base.@kwdef mutable struct BidTimeSeries
    ...
    inclusiveBidsIdentification::Union{Nothing, String} = nothing
    ...
    original_MarketDocument_revisionNumber::Union{Nothing, String} = nothing
...
function _parse(::Type{BidTimeSeries}, n::EzXML.Node)
    ...
    for c in elements(n)
        ...
        elseif nm == "inclusiveBidsIdentification"
            out.inclusiveBidsIdentification = String(strip(nodecontent(c)))
...
end  # module Reservebiddocument_v7_6
