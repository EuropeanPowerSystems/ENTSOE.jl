# Auto-generated from iec62325-451-n-measurementvalue_v1_0.xsd — DO NOT EDIT
# Re-run `gen/regenerate_xml_models.jl` to regenerate.
# Source schema namespace: urn:iec62325.351:tc57wg16:451-n:measurementvaluedocument:1:0

module Measurementvalue_v1_0
...
Base.@kwdef mutable struct TimeSeries
    ...
    businessType::String = ""
    product::String = ""
    inArea_Domain_mRID::AreaID_String = AreaID_String()
    outArea_Domain_mRID::AreaID_String = AreaID_String()
...
function _parse(::Type{TimeSeries}, n::EzXML.Node)
    ...
    for c in elements(n)
        ...
        elseif nm == "inArea_Domain.mRID"
            out.inArea_Domain_mRID = _parse(AreaID_String, c)
        elseif nm == "outArea_Domain.mRID"
            out.outArea_Domain_mRID = _parse(AreaID_String, c)
...
end  # module Measurementvalue_v1_0
